...
if(is_post_request()) {
    ...
    $service['total_amount'] = $invoice_info['total_amount'];
}
...
<section class="search">
    ...
    <div class="page new">
        ...
        <h3>Total amount is $<?php echo $service['total_amount']; ?> 
        . You still need to pay $<?php echo $service['i_amount']; ?> for this order.</h3>
