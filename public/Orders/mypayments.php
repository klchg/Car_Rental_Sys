            ...
            <?php if($payment_set!=[]){?>
                <table class="list">
				    <tr>
                        ...
                        <th><h5 style="text-align:left; color: black; font-weight:bold; ">Service Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
...
<!--                        <th><h5 style="text-align:left; color: black; font-weight:bold; ">Model&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>-->
                        ...
                        <th><h5 style="text-align:left; color: black; font-weight:bold; ">Card Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
<!--                        <th>&nbsp;</th>-->
<!--                        <th>&nbsp;</th>-->
                    </tr>
                    ...
                    while($payment = mysqli_fetch_assoc($payment_set)){ ?>
                        <tr>
						    <td>&nbsp;</td>
                            <td><h6 style="text-align:center color:#000099 "><?php echo h($payment['s_id']); ?></td>
                            <td><h6 style="text-align:center color:#000099 "><?php echo h($payment['make']); ?></td>
<!--                            <td><h6 style="text-align:center color:#000099 ">--><?php //echo h($payment['model']); ?><!--</td>-->
                            <td><h6 style="text-align:center color:#000099 "><?php echo h($payment['p_amount']); ?></td>
                            <td><h6 style="text-align:center color:#000099 "><?php echo h($payment['method']); ?></td>
                            <td><h6 style="text-align:center color:#000099 "><?php echo substr(h($payment['p_date']), 0, 10); ?></td>
                            <td><h6 style="text-align:center color:#000099 "><?php echo h(substr($payment['card_no'], 0, 4) . '********' . substr($payment['card_no'], -4)); ?></td>
                        </tr>
                    <?php } ?>
                </table>
