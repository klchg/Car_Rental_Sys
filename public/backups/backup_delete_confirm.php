...
<section class="">
    ...
    <h3 style="text-align:center; color: #000099; font-weight:bold; text-decoration:underline">Delete Order</h3>
        ...
        &nbsp;
        <form action="<?php echo url_for('/Orders/delete_order.php?&s_id=' . h(u($service['s_id'])) . '&vid='. h(u($service['vid']))); ?>" method="post">
            <input type="hidden" name="s_id" value="<?php echo $service['s_id']?>"/>
            <input type="hidden" name="vid" value="<?php echo $service['vid']?>"/>

            <dl>
                <dt>  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Are you sure to delete this order?</dt>
            </dl>
            &nbsp;
            <div id="create_order"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            &nbsp;
        <form action="<?php echo url_for('/Orders/myorders.php'); ?>">
            <div id="create_order"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
