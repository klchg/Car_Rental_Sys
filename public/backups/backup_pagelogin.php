		...
		<div id="fom">
            ...
            <?php echo display_errors($errors); ?>
				<table height="120" align="center">
					...
					<tr>
						<td>Password:</td>
						<td><input type="password" name="password" value="<?php echo $password; ?>" placeholder="Enter Password" required></td>
					</tr>
					<tr>
						<td style="text-align:center;"><a href="pagesignup.php">Signup Here</a></td>
                        <td style="text-align:center;"><a href="forgotpassword.php">Forgot Passwork?</a></td>
